    ...
    if ( $post_type ) {
        ...
        if ('physicians' == $post_type) {
            ...
            if ( have_posts() ) :
                ...
                echo '<div class="inner-container content-width"><h2 class="post-type-heading">Locations</h2><div class="card-list-container location-card-list-container"><div class="card-list card-list-locations facetwp-template">';
