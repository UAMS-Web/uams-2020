                    ...
                    <div class="image-container">
                        ...
                        <?php if ( function_exists( 'bis_get_attachment_image' ) ) { ?>      
                            ...
                            <source 
                                ...
                                srcset="<?php echo image_sizer($image, 496, 496, 'center', 'center'); ?> 1x">
                            <source 
                                media="(min-width: 1500px)" 
                                srcset="<?php echo image_sizer($image, 453, 453, 'center', 'center'); ?> 1x">
                            <source 
                                media="(min-width: 1200px)" 
                                srcset="<?php echo image_sizer($image, 348, 348, 'center', 'center'); ?> 1x">
                            <source 
                                media="(min-width: 992px)" 
                                srcset="<?php echo image_sizer($image, 273, 273, 'center', 'center'); ?> 1x">
                            <source 
                                media="(min-width: 768px)" 
                                srcset="<?php echo image_sizer($image, 221, 221, 'center', 'center'); ?> 1x">
                            <source 
                                media="(min-width: 576px)" 
                                srcset="<?php echo image_sizer($image, 173, 173, 'center', 'center'); ?> 1x">
                            <source 
                                media="(min-width: 1px)" 
                                srcset="<?php echo image_sizer($image, 497, 497, 'center', 'center'); ?> 1x">
                            <!-- Fallback -->
