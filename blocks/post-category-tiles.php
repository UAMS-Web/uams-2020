...
?>
<section class="uams-module stacked-image-text post-category-tiles<?php echo $className; ?><?php echo $block ? ' ' . $background_color : ''; ?>" id="<?php echo $id; ?>" aria-label="<?php echo $heading; ?>">
