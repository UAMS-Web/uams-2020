                                    ...
                                    <a href="#" data-toggle="modal" data-target="#modal_<?php echo $i; ?>_<?php echo $id; ?>">
                                        <picture>
                                            <?php if ( function_exists( 'fly_add_image_size' ) ) { ?>  
                                                ...
                                                <source srcset="<?php echo image_sizer($image_id, gallery_image_dimension('md', 12 / $md, 1), gallery_image_dimension('md', 12 / $md, 1, $gallery_crop), 'center', 'center'); ?> 1x, <?php echo image_sizer($image_id, gallery_image_dimension('md', 12 / $md, 2), gallery_image_dimension('md', 12 / $lg, 2, $gallery_crop), 'center', 'center'); ?> 2x" 
