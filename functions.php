...
function uams_breadcrumb_home_icon( $crumb ) {
	if (is_front_page()) {
		$crumb = '<a href="'.uams_get_home_link().'" title="University of Arkansas for Medical Sciences"><span class="fas fa-home" aria-hidden="true"></span><span class="sr-only">University of Arkansas for Medical Sciences</span></a></li><li class="breadcrumb-item">'.uams_site_title().'';
	} else {
	 	$crumb = '<a href="'.uams_get_home_link().'" title="University of Arkansas for Medical Sciences"><span class="fas fa-home" aria-hidden="true"></span><span class="sr-only">University of Arkansas for Medical Sciences</span></a></li><li class="breadcrumb-item"><a href="' . home_url() . '" title="' . uams_site_title() . '">'.uams_site_title().'</a>';
	}
     return $crumb;
}
