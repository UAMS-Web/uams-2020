...
function uams_register_blocks() {
    ...
    if( function_exists('acf_register_block_type') ) {
        ...
        acf_register_block_type(array(
            'name'              => 'uams-innersection',
            'title'             => __('UAMS Section'),
            'description'       => __('Section for basic content'),
            'category'          => 'common',
            'icon'              => 'welcome-widgets-menus',
            'keywords'          => array('uams', 'content'),
            'mode'              => 'preview',
            'align'             => 'full',
            'render_template'   => 'blocks/innersection.php',
            'supports'		=> [
                'anchor'		=> true,
...
if( function_exists('acf_add_local_field_group') ):
    ...
    acf_add_local_field_group(array(
        'key' => 'group_uams_innersection',
        'title' => 'Block: UAMS Section',
        'fields' => array(
            array(
                'key' => 'field_innersection_intro'. $suffix,
                'label' => '',
                'name' => '',
                'type' => 'message',
                'instructions' => '',
                ...
                'message' => '<h2>UAMS Section</h2>',
                'new_lines' => '',
                'esc_html' => 0,
            ),
            array(
                'key' => 'field_innersection_heading'. $suffix,
                'label' => 'Heading',
                'name' => 'innersection_heading',
                'type' => 'text',
                'instructions' => '',
                'required' => 1,
                'conditional_logic' => 0,
                ...
                'acfe_permissions' => '',
                'default_value' => 'Heading for Section',
                'placeholder' => '',
                'prepend' => '',
                'append' => '',
                'maxlength' => '',
            ...
            array(
                'key' => 'field_innersection_hide_heading'. $suffix,
                'label' => 'Hide Heading',
                'name' => 'innersection_hide_heading',
                'type' => 'true_false',
            ...
            array(
                'key' => 'field_innersection_background_color'. $suffix,
                'label' => 'Background Color',
                'name' => 'innersection_background_color',
                'type' => 'select',
                'instructions' => '',
                'required' => 1,
                'conditional_logic' => 0,
