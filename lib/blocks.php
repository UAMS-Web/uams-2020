...
if( function_exists('acf_add_local_field_group') ):
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array(
                'key' => 'field_post-cat-tiles_intro-message',
                'label' => '',
                'name' => '',
                'type' => 'message',
                'instructions' => '',
            ...
            array(
                'key' => 'field_post-cat-tiles_heading',
                'label' => 'Module Heading',
                'name' => 'post-cat-tiles_heading',
                'type' => 'text',
                'instructions' => 'Even if this heading is hidden, it is necessary for accessibility.',
                'required' => 1,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_post-cat-tiles_hide-heading',
                'label' => 'Hide the Module Heading?',
                'name' => 'post-cat-tiles_hide-heading',
                'type' => 'true_false',
                'instructions' => '',
                'required' => 1,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_post-cat-tiles_background-color',
                'label' => 'Background Color',
                'name' => 'post-cat-tiles_background-color',
                'type' => 'select',
                'instructions' => '',
                'required' => 1,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_post-cat-tiles_section',
                'label' => 'Items',
                'name' => 'post-cat-tiles_section',
                'type' => 'repeater',
                'instructions' => '',
                'required' => 1,
                'conditional_logic' => 0,
                ...
                'sub_fields' => array(
                    array(
                        'key' => 'field_post-cat-tiles_section_category',
                        'label' => 'Post Category',
                        'name' => 'post-cat-tiles_section_category',
                        'type' => 'taxonomy',
                        'instructions' => '',
                        'required' => 1,
                        'conditional_logic' => 0,
                    ...
                    array(
                        'key' => 'field_post-cat-tiles_section_post-button-text',
                        'label' => 'Post\'s Button Text',
                        'name' => 'post-cat-tiles_section_post-button-text',
                        'type' => 'text',
                    ...
                    array(
                        'key' => 'field_post-cat-tiles_section_category-button-text',
                        'label' => 'Category Link\'s Button Text',
                        'name' => 'post-cat-tiles_section_category-button-text',
                        'type' => 'text',
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array(
                'key' => 'field_post-cat-tile_intro-message',
                'label' => '',
                'name' => '',
                'type' => 'message',
                'instructions' => '',
                ...
                'message' => '<h2>Post Category Tile (Single)</h2>
    <p>This block is only intended to be used on the sidebar layout.</p>',
                'new_lines' => '',
                'esc_html' => 0,
            ),
            array(
                'key' => 'field_post-cat-tile_heading',
                'label' => 'Heading',
                'name' => 'post-cat-tile_heading',
                'type' => 'text',
                'instructions' => '',
                'required' => 1,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_post-cat-tile_hide-heading',
                'label' => 'Hide Heading?',
                'name' => 'post-cat-tile_hide-heading',
                'type' => 'true_false',
                'instructions' => '',
                'required' => 1,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_post-cat-tile_category',
                'label' => 'Post Category',
                'name' => 'post-cat-tile_category',
                'type' => 'taxonomy',
                'instructions' => '',
                'required' => 1,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_post-cat-tile_post-button-text',
                'label' => 'Post Link\'s Button Text',
                'name' => 'post-cat-tile_post-button-text',
                'type' => 'text',
                'instructions' => 'Text for the button linking to the individual post',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_post-cat-tile_category-button-text',
                'label' => 'Category Link\'s Button Text',
                'name' => 'post-cat-tile_category-button-text',
                'type' => 'text',
                'instructions' => 'Text for the button linking to the full category',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_post-cat-tile_background-color',
                'label' => 'Background Color',
                'name' => 'post-cat-tile_background-color',
                'type' => 'select',
                'instructions' => '',
                'required' => 1,
                'conditional_logic' => 0,
